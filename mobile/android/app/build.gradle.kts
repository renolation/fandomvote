...
// Thông tin ký release đọc từ android/key.properties (không commit — xem android/.gitignore).
// Không có file → build release vẫn chạy nhưng ký bằng debug key (không lên store được).
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.fandomvote.app"
