// Thể lệ campaign — bộ quy tắc GLOBAL áp dụng mọi campaign (đồng bộ thiết kế FandomVote).
// Hiển thị ở modal "📋 Thể lệ"; per-campaign rulesContent là ghi chú riêng (nếu có).
export const CAMPAIGN_RULES: string[] = [
